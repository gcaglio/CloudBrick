...
#define CONFIG_VERSION "out2-pwm_v3"
...
/*
// Set output parameter for OUTPUT2 for INVERTED PWM mode
void setout2_ipwm(){
  String outString="";
  ...
  if (out2_status==0){
    ...
    if (out2_polarity==0){
      ...
      //rotate CCW
      digitalWrite(out2_ipwm_PIN1, LOW);
      // set PWM output
      analogWrite(out2_ipwm_PIN2,out2_pwr);   
      ...
      //rotate CCW
      digitalWrite(out2_ipwm_PIN2, LOW);
      // set PWM output
      analogWrite(out2_ipwm_PIN1,out2_pwr);  
